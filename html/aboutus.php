            ...
            <div class="profile-cards-grid">
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/hari_snippet.php";
                        ?>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/ivan_snippet.php";
                        ?>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/rehan_snippet.php";
                        ?>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/thulasi_snippet.php";
                        ?>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/harir_snippet.php";
                        ?>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="profile-details">
                        <?php 
                            include "about_me_snippet/NT_snippet.php";
                        ?>
                    </div>
                </div>
            </div>
