    ...
    if ($stageId == 1) {
        $questions_1 = [
            ...
            [
                ...
                known as the 'father' of all programming languages?",
            ...
            [
                "question" => "Which company developed the Python
            ...
            [
                "question" => "Which protocol is used for secure
                communication over a computer network?",
                "options" => ["HTTP", "FTP", "SSH", "SMTP"],
                "correct_answer" => "SSH"
            ],
            [
                "question" => "Which data structure uses a
            ...
            [
                "question" => "What is the maximum value that can be
                represented with a single byte?",
