            ...
            <p>
                <ul class="instruction-list">
                    <li class="instruction-item">
                        <strong>Guess Letters:</strong> Players must guess one
                        letter at a time to uncover the hidden word.
                    </li>
                    <li class="instruction-item">
                        <strong>Fill in the Blank:</strong> Correct guesses
                        fill in the blanks of the hidden word, revealing
                        more of the word with each correct guess.
                    </li>
                    <li class="instruction-item">
                        <strong>Watch Out for Mistakes:</strong> Incorrect
                        guesses result in drawing a hangman figure.
                        Be cautious not to make too many mistakes!
                    </li>
                    <li class="instruction-item">
                        <strong>Winning:</strong> Players win by correctly
                        guessing the entire word before the hangman is fully
                        drawn.
                    </li>
                    <li class="instruction-item">
                        <strong>Losing:</strong> If the hangman
                        is completed before guessing the word correctly,
                        it's Game Over.
                    </li>
                    <li class="instruction-item">
